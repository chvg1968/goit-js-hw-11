...
async function getPhotos(query, page) {
    ...
    try {
        const response = await (0, _axiosDefault.default).get(apiUrl);
        if (response.data.hits.length === 0) (0, _notiflixNotifyAio.Notify).failure("No results found. Please try again.");
...
function loadImages(photos) {
    ...
    if (pageNum * 40 >= totalHits) (0, _notiflixNotifyAio.Notify).info("We\xb4re sorry, but you\xb4ve reached the end of search results.");
}
...
function init() {
    ...
    searchPhotos(searchQuery, pageNum).then((data)=>{
        ...
        if (data.totalHits === 0) (0, _notiflixNotifyAio.Notify).failure("No results found. Please try again.");
    });
}
init();

},{"axios":"jo6P5","notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
